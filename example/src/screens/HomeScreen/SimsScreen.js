    ...
    <View style={styles.foregroundContainer}>
      ...
      <View style={styles.foregroundDetails}>
        ...
        <View style={styles.foregroundActionsContainer}>
          ...
          <Image source={require('../../assets/icons/share.png')} style={styles.foregroundActionsShare} resizeMode="contain"/>
        </View>
      </View>
    </View>
  </View>
      ...
      <TouchableOpacity style={[ styles.headerButtonContainer, { left }]}>
        <Animated.View style={[styles.headerButton, { opacity: arrowOpacity }]}>
          <Image
            ...
            source={{
              uri:
                'https://cdn.iconscout.com/icon/free/png-256/chevron-25-433513.png',
            }}
          />
        </Animated.View>
      </TouchableOpacity>
      ...
      <View style={styles.headerWrapper}>
        <Animated.View style={[styles.headerSearchContainer, { opacity }]}>
          <Image
            ...
            source={{
              uri:
                'https://www.shareicon.net/data/512x512/2016/05/19/767484_arrows_512x512.png',
            }}
          />
          <Text
