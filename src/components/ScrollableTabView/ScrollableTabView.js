...
import { any, bool, func, node, number } from 'prop-types'
import SceneComponent from './SceneComponent'
import { constants } from '../../constants'
import styles from './ScrollableTabView.styles'
...
class ScrollableTabView extends React.Component {
  ...
  renderScrollableContent() {
    ...
    const { initialPage, locked } = this.props
  ...
  render() {
    const { containerWidth, currentPage, scrollValue } = this.state
